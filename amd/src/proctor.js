...
export const init = () => {
    ...
    const configEl = document.getElementById('ai-proctor-config');
    const configData = configEl ? configEl.dataset : {};
    const CONFIG = {
        course_id: parseInt(configData.course_id),
        sess_key: configData.sess_key,
        upload_url: configData.upload_url,
        verified_key: configData.verified_key,
        count_key: configData.count_key,
        ...
        institution_code: configData.institution_code,
        analytics_enabled: configData.analytics_enabled === 'true',
    ...
    class AIProctorAnalytics {
        constructor() {
            ...
            this.trackingData = {
                ...
                user_hash: this.hashUserId(CONFIG.user_id),
