...
// Additional Strings for Frontend
$string['settings'] = 'Settings';
$string['enable_proctoring'] = 'Enable Proctoring?';
$string['enable_for_exams'] = 'Enable only for Exams.';
$string['command_center'] = 'Command Center';
$string['status'] = 'Status';
$string['strikes'] = 'Strikes';
$string['active'] = 'Active';
$string['face_lost'] = 'Face Lost. Return to continue.';
$string['exam_hidden'] = 'EXAM HIDDEN';
$string['position_required'] = 'Position Adjustment Required';
$string['warning_timer'] = 'You have 8 seconds to adjust your position';
$string['shield_title'] = 'AI Proctor System';
$string['shield_status_init'] = 'Initializing secure monitoring...';
$string['step_system'] = 'Checking system requirements...';
$string['step_camera'] = 'Checking camera support...';
$string['step_access'] = 'Requesting camera access...';
$string['step_model'] = 'Loading AI model...';
$string['step_framework'] = 'Loading AI framework...';
$string['step_face'] = 'Initializing face detection...';
$string['step_scan'] = 'Environment scan required...';
$string['shield_connection'] = 'Secure Connection Established';
$string['risk_level'] = 'Risk Level';
$string['eye_tracking'] = 'Eye Tracking';
$string['powered_by'] = 'Powered by Qigen';
